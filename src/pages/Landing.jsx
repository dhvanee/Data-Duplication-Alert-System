        ...
        <div className="mt-24">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="relative group h-full">
              <div className="h-full bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-200 hover:shadow-xl">
                <div className="p-6 flex flex-col h-full">
                  ...
                  <p className="text-gray-600 flex-grow">Automatically scan and identify duplicate records across your datasets using advanced matching algorithms.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group h-full">
              <div className="h-full bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-200 hover:shadow-xl">
                <div className="p-6 flex flex-col h-full">
                  ...
                  <p className="text-gray-600 flex-grow">Gain clear insights through interactive charts and graphs showing data duplication patterns.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group h-full">
              <div className="h-full bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-200 hover:shadow-xl">
                <div className="p-6 flex flex-col h-full">
                  ...
                  <p className="text-gray-600 flex-grow">Seamlessly import and export data from various file formats including CSV, Excel and more.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group h-full">
              <div className="h-full bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-200 hover:shadow-xl">
                <div className="p-6 flex flex-col h-full">
                  ...
                  <p className="text-gray-600 flex-grow">Receive intelligent recommendations for handling duplicates based on your data patterns.</p>
                </div>
              </div>
            </div>
          </div>
